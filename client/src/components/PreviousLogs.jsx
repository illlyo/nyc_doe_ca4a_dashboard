                    ...
                    <div className="review-text">
                      <div className="review-intro-card">
                        <div className="review-intro-card-header">
                          ...
                          <p>{this.props.getStore().coach_name}</p>
                          <h4 className="intro-card-headers" style={{
                              "float" : "right"
                            }}>Date of visit:
                            <span className="review-response">{this.props.getStore().date_of_visit}</span>
                          </h4>
                        </div>
                        <div style={{
                            "padding" : 10
                          ...
                          <span className="review-response">
                            {this.props.getStore().school_visited}</span>
                          ...
                          <div className="related-content">
                            <h3 className="intro-card-headers">Length of visit:
                              <span className="review-response">{this.props.getStore().length_of_visit}
                                minutes</span>
                            </h3>
                            <h3 className="intro-card-headers" style={{
                                "float" : "right"
                              }}>Was today's meeting cancelled?:
                              <span className="review-response">{this.props.getStore().cancelled}</span>
                            </h3>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="review-div-border-right">
                          ...
                          <div className="review-response">
                            Facilitated meeting with team:{
                              (this.props.getStore().interact_meeting_with_team == 1)
                                ? <span>&#10003;</span>
                                : ''
                            }<br></br>
                            Observed Practice:{
                              (this.props.getStore().interact_observed_practice == 1)
                                ? <span>&#10003;</span>
                                : ''
                            }<br></br>
                            Checked in with leadership:{
                              (this.props.getStore().interact_with_leadership == 1)
                                ? <span>&#10003;</span>
                                : ''
                            }<br></br>
                            Checked in with Team Lead:{
                              (this.props.getStore().interact_with_team_lead == 1)
                                ? <span>&#10003;</span>
                                : ''
                            }<br></br>
                            Facilitated a PD:{
                              (this.props.getStore().interact_with_pd == 1)
                                ? <span>&#10003;</span>
                                : ''
                            }<br></br>
                            Other:{
                              (this.props.getStore().interact_with_other == 1)
                                ? <span>&#10003;</span>
                                : ''
                            }<br></br>
                      ...
                      <div className="review-div">
                        <div className="review-div-border-right">
                          ...
                          <div className="review-response">
                            Academic Skills:{
                              (this.props.getStore().academic_skills == 1)
                                ? <span>&#10003;</span>
                                : ''
                            }<br></br>
                            Academic Personal Behavior:{
                              (this.props.getStore().academic_personal_behavior == 1)
                                ? <span>&#10003;</span>
                                : ''
                            }<br></br>
                            Academic Programming:{
                              (this.props.getStore().academic_programming == 1)
                                ? <span>&#10003;</span>
                                : ''
                            }<br></br>
                            College Career Access:{
                              (this.props.getStore().college_career_access == 1)
                                ? <span>&#10003;</span>
                                : ''
                            }<br></br>
                          </div>
                      ...
                      <div className="review-div" style={{
                        ...
                        <div style={{
                          ...
                          <div className="review-response">
                            {
                              (this.props.getStore().goals_met == 1)
                                ? <span>Goals were not defined</span>
                                : ''
                            }
                            {
                              (this.props.getStore().goals_met == 2)
                                ? <span>Goals were not at all met</span>
                                : ''
                            }
                            {
                              (this.props.getStore().goals_met == 3)
                                ? <span>Goals were somewhat met</span>
                                : ''
                            }
                            {
                              (this.props.getStore().goals_met == 4)
                                ? <span>Goals were sufficiently met</span>
                                : ''
                            }
                            {
                              (this.props.getStore().goals_met == 5)
                        ...
                        <div style={{
                          ...
                          <div className="review-response">
                            {
                              (this.props.getStore().rate_learning_trajectory == 1)
                                ? <span>N/A</span>
                                : ''
                            }
                            {
                              (this.props.getStore().rate_learning_trajectory == 2)
                                ? <span>No progress</span>
                                : ''
                            }
                            {
                              (this.props.getStore().rate_learning_trajectory == 3)
                                ? <span>A little</span>
                                : ''
                            }
                            {
                              (this.props.getStore().rate_learning_trajectory == 4)
                                ? <span>Some</span>
                                : ''
                            }
                            {
                              (this.props.getStore().rate_learning_trajectory == 5)
                      ...
                      <div className="review-div">
                        <div>
                          ...
                          <div className="review-response">
                            Inquiry Institute: {
                              (this.props.getStore().inquiry_institute == 1)
                                ? <span>&#10003;</span>
                                : ''
                            }<br></br>
                            Research: {
                              (this.props.getStore().research == 1)
                                ? <span>&#10003;</span>
                                : ''
                            }<br></br>
                            Design: {
                              (this.props.getStore().design == 1)
                                ? <span>&#10003;</span>
                                : ''
                            }<br></br>
                            PDSA: {
                              (this.props.getStore().pdsa == 1)
                                ? <span>&#10003;</span>
                                : ''
                            }<br></br>
                            Synthesize: {
                              (this.props.getStore().synthesize == 1)
                                ? <span>&#10003;</span>
                                : ''
                            }<br></br>
                            Scale: {
                              (this.props.getStore().scale == 1)
                                ? <span>&#10003;</span>
                                : ''
                            }<br></br>
                          </div>
